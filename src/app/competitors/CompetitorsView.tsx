                              ...
                              if (hasNewSocial) {
                                return (
                                  <div className="flex flex-col gap-1 mt-2 text-[10px] text-white/50 font-mono">
                                    {intel.socialMedia?.instagram && intel.socialMedia?.instagram !== 'Not Publicly Available' && (
                                      <a href={intel.instagramUrl || `https://instagram.com/${intel.socialMedia?.instagram.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-blue-400 transition-colors" onClick={(e) => e.stopPropagation()}>
                                    ...
                                    {intel.socialMedia?.facebook && intel.socialMedia?.facebook !== 'Not Publicly Available' && (
                                      <a href={intel.facebookUrl || `https://facebook.com/${intel.socialMedia?.facebook.replace(' ', '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-blue-400 transition-colors" onClick={(e) => e.stopPropagation()}>
